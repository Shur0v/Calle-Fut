      ...
      <div className="w-[638px] h-[488px] p-6 bg-white rounded-xl flex-col justify-start items-start gap-5 inline-flex relative shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmitForm)} className="w-full">
          <div className="self-stretch h-[372px] flex-col justify-start items-start gap-6 flex">
            <div className="self-stretch text-[#070707] text-2xl font-medium font-['Montserrat'] leading-normal">Add Email Template</div>
              ...
              <div className="self-stretch justify-start items-start gap-4 inline-flex">
                <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                  ...
                  <textarea
                    ...
                    className="w-full h-[116px] px-5 py-[13px] rounded-lg border border-[#e5e1e1] text-[#777980] text-sm font-normal font-['Montserrat'] resize-none"
                  />
                  {errors.body && (
          ...
          <div className="justify-start items-start gap-4 inline-flex mt-6">
            ...
            >
              <div className="text-white text-base font-medium font-['Montserrat'] leading-none">Save</div>
            </button>
            <button
              type="button"
              onClick={() => {
            ...
            >
              <div className="text-[#b60000] text-base font-medium font-['Montserrat'] leading-none">Cancel</div>
            </button>
          </div>
        </form>
      </div>
