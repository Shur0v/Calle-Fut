            ...
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                ...
                <div className="w-full min-h-[56px] rounded-lg border border-[#E5E1E1] p-4">
                  <div className="text-[#777980] text-sm font-normal font-['Montserrat']">{data?.name || ''}</div>
                </div>
              </div>
            </div>
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                ...
                <div className="w-full min-h-[56px] rounded-lg border border-[#E5E1E1] p-4">
                  <div className="text-[#777980] text-sm font-normal font-['Montserrat']">{data?.age || ''}</div>
                </div>
              </div>
            </div>
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                ...
                <div className="w-full min-h-[56px] rounded-lg border border-[#E5E1E1] p-4">
                  <div className="text-[#777980] text-sm font-normal font-['Montserrat']">{data?.email || ''}</div>
                </div>
              </div>
            </div>
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="w-full self-stretch justify-start items-start gap-4 flex">
                <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                  ...
                  <div className="w-full min-h-[56px] rounded-lg border border-[#E5E1E1] p-4">
                    <div className="text-[#777980] text-sm font-normal font-['Montserrat']">{data?.joinDate || ''}</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="w-full self-stretch justify-start items-start gap-4 flex">
                <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                  ...
                  <div className="w-full min-h-[56px] rounded-lg border border-[#E5E1E1] p-4">
                    <div className="text-[#777980] text-sm font-normal font-['Montserrat']">{data?.time || ''}</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="w-full self-stretch justify-start items-start gap-4 flex">
                <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                  ...
                  <div className="w-full min-h-[56px] rounded-lg border border-[#E5E1E1] p-4">
                    <div className="text-[#777980] text-sm font-normal font-['Montserrat']">{data?.status || ''}</div>
                  </div>
                </div>
              </div>
            </div>
