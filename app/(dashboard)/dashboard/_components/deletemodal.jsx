    ...
    >
      <div className="w-[500px] p-6 bg-white rounded-xl flex-col justify-start items-start gap-5 inline-flex relative shadow-lg">
        ...
        <div className="self-stretch flex-col justify-start items-start gap-6 flex">
          <div className="self-stretch text-[#070707] text-2xl font-medium font-['Montserrat'] leading-normal">Delete Confirmation</div>
          ...
          <div className="self-stretch flex-col justify-start items-center gap-6 flex">
            ...
            <div className="flex items-center gap-4 mt-4">
              <button
                ...
                className="px-6 py-3 bg-[#b60000] rounded-lg justify-center items-center gap-1.5 flex hover:bg-[#a00000] transition-colors"
              >
                <span className="text-white text-base font-medium font-['Montserrat'] leading-none">Yes, Delete</span>
              </button>
              <button
                onClick={onClose}
                className="px-6 py-3 rounded-lg border border-[#db0000]/30 justify-center items-center gap-1.5 flex hover:bg-[#ffefef] transition-colors"
              >
                <span className="text-[#b60000] text-base font-medium font-['Montserrat'] leading-none">No, Cancel</span>
              </button>
            </div>
          </div>
        </div>
